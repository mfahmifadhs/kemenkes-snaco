                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card border border-dark">
                            <div class="card-body">
                                ...
                                <p class="text-xs">Monitoring persediaanmu dengan menambah pemakaian</p>
                                <a href="{{ route('kegiatan.create') }}" class="btn btn-success btn-xs"><i class="fas fa-plus-circle"></i> Tambah Kegiatan</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-9">
                                    ...
                                    <table id="table-data" class="table table-striped">
                                        ...
                                        <tbody class="text-xs">
                                            ...
                                            <tr class="bg-white">
                                                ...
                                                <td class="text-center">{{ number_format($row->stokMasukUker()->where('uker_id', Auth::user()->pegawai->uker_id)->sum('jumlah_permintaan'), 0, '.') }}</td>
                                                <td class="text-center">{{ number_format($row->stokKeluarUker()->where('uker_id', Auth::user()->pegawai->uker_id)->sum('jumlah'), 0, '.') }}</td>
                                                <td class="text-center">{{ number_format($row->stokUker(Auth::user()->pegawai->uker_id), 0, '.') }}</td>
