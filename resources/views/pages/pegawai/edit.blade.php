        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('pegawai.show') }}">Daftar</a></li>
    ...
    <div class="container-fluid col-md-7">
        <div class="card border border-dark">
            <div class="card-header">
                <label class="mt-2">Pegawai User</label>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            <select id="utamaSelect" name="utama" class="form-control rounded">
                                ...
                                <option value="{{ $row->id_unit_utama }}" <?php echo $data->uker->utama_id == $row->id_unit_utama ? 'selected' : ''; ?>>
                                    {{ $row->unit_utama }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <select id="ukerSelect" name="uker" class="form-control rounded">
                                <option value="{{ $data->uker_id }}">
                                    {{ $data->uker->unit_kerja }}
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6 form-group">
                            <label>NIP*</label>
                            <input type="number" class="form-control rounded" name="nip" min="1" value="{{ $data->nip }}" required>
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Nama Pegawai*</label>
                            <input type="text" class="form-control rounded" name="pegawai" value="{{ $data->nama_pegawai }}" required>
                        </div>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select name="timker" class="form-control rounded">
                                ...
                                <option value="{{ $row->id_tim_kerja }}" <?php echo $data->timker_id == $row->id_tim_kerja ? 'selected' : ''; ?>>
                                    {{ $row->tim_kerja }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="true" type="radio" name="status" value="true" <?php echo $data->status == 'true' ? 'checked' : ''; ?>>
                            <label for="true" class="mt-2 ml-2 mr-4">Aktif</label>
                            <input id="false" type="radio" name="status" value="false" <?php echo $data->status == 'false' ? 'checked' : ''; ?>>
