...
<section class="content">
    <div class="container col-md-9">
        <div class="card border border-dark">
            ...
            <form id="form-submit" action="{{ route('snaco.stok.update', $stok->id_stok) }}" method="POST">
                @csrf
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <span class="w-75 input-group"><span class="col-form-label mx-2">:</span>
                                    <input type="date" class="form-control rounded" name="tanggal_masuk" value="{{ Carbon\Carbon::parse($stok->tanggal_masuk)->format('Y-m-d') }}" required>
                                </span>
                            </div>
                            ...
                            <div class="input-group mt-2">
                                ...
                                <span class="w-75 input-group"><span class="col-form-label mx-2">:</span>
                                    <input type="text" class="form-control rounded" name="no_kwitansi" value="{{ $stok->no_kwitansi }}">
                                </span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <span class="w-75 input-group"><span class="col-form-label mx-2">:</span>
                                    <input type="text" class="form-control number rounded" name="total_harga" value="{{ number_format($stok->total_harga, 0, '', '.') }}" required>
                                </span>
                            </div>
                            ...
                            <div class="input-group mt-2">
                                ...
                                <span class="w-75 input-group"><span class="col-form-label mx-2">:</span>
                                    <input type="text" class="form-control rounded" name="keterangan" value="{{ $stok->keterangan }}" required>
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body small">
                    ...
                    <div class="table-responsive" style="max-height: 230px; overflow-y: auto;">
                        <table class="table table-bordered text-center text-sm">
                            ...
                            <tbody>
                                @foreach($stok->detail as $index => $row)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="" class="btn btn-default btn-xs bg-danger rounded" onclick="confirmRemove(event, `{{ route('snaco.stok.item.delete', ['aksi' => 'stok', 'id' => $row->id_detail]) }}`)">
                                        ...
                                        <div class="modal fade text-left" id="editItem-{{ $row->id_detail }}" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form id="form-edit-{{ $row->id_detail }}" action="{{ route('snaco.stok.item.update', $row->id_detail) }}" method="POST">
                                                        @csrf
                                                        <input type="hidden" name="stok_id" value="{{ $stok->id_stok }}">
